...
class AuthRepositoriesImpl extends AuthRepository {
  ...
  Future<Either<Failure, bool>> sendOtp({
    ...
    final Either<Failure, dynamic> failureOrSuccess = await repositoryHelper
        .callAPI(() async {
  ...
  Future<Either<Failure, User?>> verifyOtp({
    ...
    Either<Failure, dynamic> failureOrSuccess = await repositoryHelper.callAPI(
      () async {
